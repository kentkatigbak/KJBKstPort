...
with st.sidebar:
    choose = option_menu("Kent Jym Katigbak", ["Introduction", "About Me", "Education", "Licenses and Certifications", "Other Achievements", "Let's Connect"],
                        styles={
...
if choose == "Licenses and Certifications":
